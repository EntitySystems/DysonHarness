...
| `DysonLongRunningShellSelfCheck` | Assert-only long-running shell catalog (7 tools) + List/ShellExited trim + outcome mapping + id allocation + abort (UI `Program` startup) |
