...
public static class DysonBeginBuildPlanFlow
{
        ...
        IReadOnlyList<string>? reportBlocks = null)
    {
        ...
        var instruction = $"""
            ...
            ## Recap
            Brief restatement of the plan goal and constraints (enough for later turns without re-reading the whole file).
            ## Agent actions
            An ordered, concrete checklist of who/what comes next (e.g. Drone briefs, solution setup, verify steps).
