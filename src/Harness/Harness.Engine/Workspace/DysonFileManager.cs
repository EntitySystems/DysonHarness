...
/// <summary>
/// ponytail: assert-only self-check for slug/hash naming + plans path sandbox (no test framework).
/// Run: <c>DysonFileManagerSelfCheck.Run()</c> (also from UI <c>Program</c> startup).
/// </summary>
public static class DysonFileManagerSelfCheck
{
