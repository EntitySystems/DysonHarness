...
public static class ColorCodeLanguages
{
    ...
    [
        ...
        new("xml", "XML", "xml",
            ["xaml", "axml", "csproj", "fsproj", "vbproj", "vcxproj", "vcproj", "proj", "msbuildproj", "targets", "props", "projitems", "pubxml", "filters", "wixproj", "njsproj", "sqlproj", "pyproj", "shproj", "ccproj", "sfproj", "deployproj", "msbuild"],
            [".xml", ".xaml", ".axml", ".csproj", ".fsproj", ".vbproj", ".vcxproj", ".vcproj", ".proj", ".msbuildproj", ".targets", ".props", ".projitems", ".pubxml", ".filters", ".wixproj", ".njsproj", ".sqlproj", ".pyproj", ".shproj", ".ccproj", ".sfproj", ".deployproj"]),
        new("css", "CSS", "css", [], [".css"]),
        new("sql", "SQL", "sql", [], [".sql"]),
